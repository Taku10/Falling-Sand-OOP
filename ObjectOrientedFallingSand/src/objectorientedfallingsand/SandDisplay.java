...
public class SandDisplay extends JComponent implements MouseListener, MouseMotionListener, ActionListener, ChangeListener
{
    ...
    public SandDisplay(String title, int numRows, int numCols, Particle[] inParticles)
    {
        ...
        buttons = new JButton[particles.length];

        for (int i = 0; i < buttons.length; i++)
        {
            buttons[i] = new JButton(particles[i].getName());
